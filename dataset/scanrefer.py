...
class ScanReferDataset(Dataset, LoadScannetMixin, DataAugmentationMixin):
    def __init__(self, split='train', max_obj_len=60, num_points=1024, pc_type='gt', sem_type='607', filter_lang=False, drop_sample=0.0):
        ...
        # load file
        anno_file = os.path.join('./data/scanfamily/annotations/refer/scanrefer.jsonl')
        split_file = '/home/fengyanglin/vsepp-python3/ScanRefer_filtered_'+ split +'.txt'
    ...
    def __getitem__(self, idx):
        ...
        # convert to torch -- torch.Size([50, 1024, 6]) torch.Size([50, 6]) torch.Size([50, 6])
...
if __name__ == '__main__':
    dataset = ScanReferDataset(split='train', pc_type='gt')
    dataset[0]
    dataset[0]
    dataset[0]